...
$query = mysqli_query($koneksi, "SELECT tbl_siswa.id, tbl_siswa.nama, tbl_siswa.nis, tbl_siswa.kelas, tbl_siswa.angkatan, tbl_siswa.foto, tbl_siswa.alamat, tbl_jurusan.nama_jurusan AS jurusan FROM tbl_siswa LEFT JOIN tbl_jurusan ON tbl_siswa.id_jurusan = tbl_jurusan.id");
$no = 1;
$active = 'master';
?>
<!DOCTYPE html>
...
<head>
	...
	<title>Data Alumni - SMA Negeri 1 KRUI</title>
