...
<head>
	...
	<title>Ubah Siswa - SMA Negeri 1 KRUI</title>
					...
					<div class="card-body">
						<form method="POST" action="proses_ubah.php?id=<?= $siswa['id'] ?>" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" value="<?= $siswa['kelas'] ?>" class="form-control" id="kelas" placeholder="kelas" autocomplete="off" required="required" name="kelas">
							</div>

							<div class="form-group">
								<label for="angkatan">Angkatan</label>
								<input type="number" value="<?= $siswa['angkatan'] ?>" class="form-control" id="angkatan" placeholder="angkatan" autocomplete="off" required="required" name="angkatan">
							</div>
