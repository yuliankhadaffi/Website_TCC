...
<head>
	...
	<title>Tambah Alumni - SMA Negeri 1 KRUI</title>
					...
					<div class="card-body">
						<form method="POST" action="proses_tambah.php" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="nis" placeholder="kelas" autocomplete="off" required="required" name="kelas">
							</div>

							<div class="form-group">
								<label for="angkatan">Angkatan</label>
								<input type="number" class="form-control" id="nis" placeholder="angkatan" autocomplete="off" required="required" name="angkatan">
							</div>
							<div class="row">
								<div class="col">
									<div class="form-group">
