...
<head>
	...
	<title>Teknokrat Computer Competition || Data Kompetisi</title>
				...
				<div class="card shadow">
					...
					<div class="card-body">
						<form method="POST" action="proses_tambah.php" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label for="no_hp">Penanggungjawab Lomba</label>
								<input type="text" class="form-control" id="pjlomba" placeholder="PJ Lomba" autocomplete="off" required="required" name="pjlomba">
							</div>

							<div class="form-group">
								<label for="biaya">Biaya Lomba</label>
								<input type="text" class="form-control" id="biaya" placeholder="Biaya" autocomplete="off" required="required" name="biaya">
							</div>
